...
if __name__ == "__main__":
    ...
    Task: Write an email response to the following email from a student with answers to their questions given the following context as short as possible with only relevant information.
